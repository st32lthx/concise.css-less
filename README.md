...
- Use [GitHub Issues](http://github.com/ConciseCSS/concise.css-less/issues) if you want to **ask a general question**
- Submit a [pull request](https://help.github.com/articles/creating-a-pull-request) if you **want to contribute**

## Contributing

If you wish to contribute to the Concise project, please read through our [contributing guidelines](https://github.com/ConciseCSS/concise.css-less/blob/master/CONTRIBUTING.md) first. This will ensure that you are posting things in the proper areas and you are following our coding standards. 
